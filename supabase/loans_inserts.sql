...
-- Ajuste a lista de nomes na CTE company_map caso precise incluir novas empresas.
...
loans_data as (
  select * from (values
      ('Logica Distribuicao', 'Capital de Giro FGI', 'Bradesco', '237/1497/2806', 'Operação Congelados', 731292.36, 524013.85, 731292.36, 207278.51, 46,
      ...
      ('Logica Distribuicao', 'Capital de Giro FGI', 'Bradesco', '237/1497/1000', 'Operação Congelados', 1462585.18, 1048027.68, 1462585.18, 414557.50, 46,
      ...
      ('Logica Distribuicao', 'CDC', 'Itaú', '288504', 'Operação Congelados', 502468.20, 355000.00, 502468.20, 147468.20, 60,
      ...
      ('Logica Distribuicao', 'BNDES', 'Bradesco', 'Finame Materiais', 'Operação Congelados', 540225.75, 540225.75, 540225.75, 0.00, 36,
      ...
      ('Logica Distribuicao', 'CDC', 'Mercedes (Prodoeste)', '1190550610', 'Compra Caminhão Triangulo M.', 412845.64, 292000.00, 412845.64, 120845.64, 60,
      ...
      ('Logica Distribuicao', 'CDC', 'Volkswagen (Gaplan)', '2921039384', 'Compra Caminhão', 568840.32, 400000.00, 568840.32, 168840.32, 48,
      ...
      ('Distribuidora Logica ZM', 'Capital de Giro FGI', 'Bradesco', '23714971010', 'Operação Congelado e Refrige', 1429466.40, 1000000.00, 1429466.40, 429466.40, 30,
       47648.88, 33333.33, 14315.55, 0.0172, 0.2268, 0, 30, 0.00, 1429466.40, '2025-10-08'::date, '2026-04-01'::date, '2026-04-01'::date, '2028-09-01'::date, '[
        {"sequence": 1, "date": "2026-04-01", "status": "pendente"},
        {"sequence": 2, "date": "2026-05-01", "status": "pendente"},
        {"sequence": 3, "date": "2026-06-01", "status": "pendente"},
        {"sequence": 4, "date": "2026-07-01", "status": "pendente"},
        {"sequence": 5, "date": "2026-08-01", "status": "pendente"},
        {"sequence": 6, "date": "2026-09-01", "status": "pendente"},
        {"sequence": 7, "date": "2026-10-01", "status": "pendente"},
        {"sequence": 8, "date": "2026-11-01", "status": "pendente"},
        {"sequence": 9, "date": "2026-12-01", "status": "pendente"},
        {"sequence": 10, "date": "2027-01-01", "status": "pendente"},
        {"sequence": 11, "date": "2027-02-01", "status": "pendente"},
        {"sequence": 12, "date": "2027-03-01", "status": "pendente"},
        {"sequence": 13, "date": "2027-04-01", "status": "pendente"},
        {"sequence": 14, "date": "2027-05-01", "status": "pendente"},
        {"sequence": 15, "date": "2027-06-01", "status": "pendente"},
        {"sequence": 16, "date": "2027-07-01", "status": "pendente"},
        {"sequence": 17, "date": "2027-08-01", "status": "pendente"},
        {"sequence": 18, "date": "2027-09-01", "status": "pendente"},
        {"sequence": 19, "date": "2027-10-01", "status": "pendente"},
        {"sequence": 20, "date": "2027-11-01", "status": "pendente"},
        {"sequence": 21, "date": "2027-12-01", "status": "pendente"},
        {"sequence": 22, "date": "2028-01-01", "status": "pendente"},
        {"sequence": 23, "date": "2028-02-01", "status": "pendente"},
        {"sequence": 24, "date": "2028-03-01", "status": "pendente"},
        {"sequence": 25, "date": "2028-04-01", "status": "pendente"},
        {"sequence": 26, "date": "2028-05-01", "status": "pendente"},
        {"sequence": 27, "date": "2028-06-01", "status": "pendente"},
        {"sequence": 28, "date": "2028-07-01", "status": "pendente"},
        {"sequence": 29, "date": "2028-08-01", "status": "pendente"},
        {"sequence": 30, "date": "2028-09-01", "status": "pendente"}
      ]'::jsonb),
      ('Distribuidora Logica ZM', 'Capital de Giro FGI', 'Bradesco', '23714971300', 'Operação Congelado e Refrige', 1840166.10, 1300000.00, 1840166.10, 540166.10, 30,
       61338.87, 43333.33, 18005.54, 0.0171, 0.2252, 0, 30, 0.00, 1840166.10, '2025-10-08'::date, '2026-05-05'::date, '2026-05-05'::date, '2028-10-05'::date, '[
        {"sequence": 1, "date": "2026-05-05", "status": "pendente"},
        {"sequence": 2, "date": "2026-06-05", "status": "pendente"},
        {"sequence": 3, "date": "2026-07-05", "status": "pendente"},
        {"sequence": 4, "date": "2026-08-05", "status": "pendente"},
        {"sequence": 5, "date": "2026-09-05", "status": "pendente"},
        {"sequence": 6, "date": "2026-10-05", "status": "pendente"},
        {"sequence": 7, "date": "2026-11-05", "status": "pendente"},
        {"sequence": 8, "date": "2026-12-05", "status": "pendente"},
        {"sequence": 9, "date": "2027-01-05", "status": "pendente"},
        {"sequence": 10, "date": "2027-02-05", "status": "pendente"},
        {"sequence": 11, "date": "2027-03-05", "status": "pendente"},
        {"sequence": 12, "date": "2027-04-05", "status": "pendente"},
        {"sequence": 13, "date": "2027-05-05", "status": "pendente"},
        {"sequence": 14, "date": "2027-06-05", "status": "pendente"},
        {"sequence": 15, "date": "2027-07-05", "status": "pendente"},
        {"sequence": 16, "date": "2027-08-05", "status": "pendente"},
        {"sequence": 17, "date": "2027-09-05", "status": "pendente"},
        {"sequence": 18, "date": "2027-10-05", "status": "pendente"},
        {"sequence": 19, "date": "2027-11-05", "status": "pendente"},
        {"sequence": 20, "date": "2027-12-05", "status": "pendente"},
        {"sequence": 21, "date": "2028-01-05", "status": "pendente"},
        {"sequence": 22, "date": "2028-02-05", "status": "pendente"},
        {"sequence": 23, "date": "2028-03-05", "status": "pendente"},
        {"sequence": 24, "date": "2028-04-05", "status": "pendente"},
        {"sequence": 25, "date": "2028-05-05", "status": "pendente"},
        {"sequence": 26, "date": "2028-06-05", "status": "pendente"},
        {"sequence": 27, "date": "2028-07-05", "status": "pendente"},
        {"sequence": 28, "date": "2028-08-05", "status": "pendente"},
        {"sequence": 29, "date": "2028-09-05", "status": "pendente"},
        {"sequence": 30, "date": "2028-10-05", "status": "pendente"}
      ]'::jsonb)
  ) as data (
    company_name,
    operation,
...
inserted_loans as (
  ...
  select
    ...
    data.as_of_date,
    data.contract_start
  from loans_data data
  join company_map on company_map.name = data.company_name
